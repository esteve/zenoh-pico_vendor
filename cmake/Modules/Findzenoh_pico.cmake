...
if(${zenoh_pico_FOUND})
  message("ASDfasfasdf FOUND====")
  set(zenoh_pico_INCLUDE_DIRS ${zenoh_pico_INCLUDE_DIR})
  set(zenoh_pico_LIBRARIES ${zenoh_pico_LIBRARY})

  # add_library(hoobafloovez UNKNOWN IMPORTED)
  # set_property(TARGET zenoh::zenohc PROPERTY IMPORTED_LOCATION ${zenoh_pico_LIBRARY})
  # set_property(TARGET zenoh::zenohc PROPERTY INTERFACE_INCLUDE_DIRECTORIES ${zenoh_pico_INCLUDE_DIR})
  # list(APPEND zenoh_pico_TARGETS zenoh::zenohc)
endif()
