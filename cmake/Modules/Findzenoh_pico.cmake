...
find_package_handle_standard_args(zenoh DEFAULT_MSG zenoh_pico_INCLUDE_DIR zenoh_pico_LIBRARY)
...
if(${zenoh_pico_FOUND})
  ...
  add_library(zenoh::zenoh UNKNOWN IMPORTED)
  set_property(TARGET zenoh::zenoh PROPERTY IMPORTED_LOCATION ${zenoh_pico_LIBRARY})
  set_property(TARGET zenoh::zenoh PROPERTY INTERFACE_INCLUDE_DIRECTORIES ${zenoh_pico_INCLUDE_DIR})
  list(APPEND zenoh_pico_TARGETS zenoh::zenoh)
endif()
